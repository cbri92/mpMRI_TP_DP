...
Voxel-wise statistics: 'Mean intensity in ROI at tp1', 'Mean intensity in ROI at tp2', 'Between voxels variance', 'Within voxels variance', 'ROI ICC (2,1)', 
'Within voxel CoV', 'Repeatability coefficient', 'RC Upper', 'RC Lower'.
