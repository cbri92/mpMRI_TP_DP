...
#     #Formula for combination of ADC and rBV: FORMULA = 1.3966 + 1.4888*ADC + 0.9816*DSC-CBV
#     ADC_mul = sitk.Multiply(ADC_norm, 1.4888)
#     rBV_mul = sitk.Multiply(rBV_norm, 0.9816)    
#     # ADC_rBV = sitk.Add(ADC_mul, rBV_mul)
#     # ADC_rBV = sitk.Add(ADC_rBV, 1.3966)
#     ADC_rBV = 1.3966 + ADC_mul + rBV_mul #Combined image generated from combination of ADC and rBV images
#     sitk.WriteImage(ADC_rBV, prob_imgs +'/ADC_rBV.nii') #Save ADC_rBV combination image    
    
#     #Formula for combination of ADC and rBF: FORMULA = 1.5916 + 1.6775*ADC + 1.7217*DSC-CBF
#     ADC_mul2 = sitk.Multiply(ADC_norm, 1.6775)
#     rBF_mul = sitk.Multiply(rBF_norm, 1.7217)
#     # ADC_rBF = sitk.Add(ADC_mul, rBF_mul)
#     # ADC_rBF = sitk.Add(ADC_rBF, 1.5916)     
#     ADC_rBF = 1.5916 + ADC_mul2 + rBF_mul #Combined image generated from combination of ADC and rBF images
